      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-1 sm:col-span-2 md:col-span-2 lg:col-span-2">
            ...
            <p className="text-gray-400 mb-4 md:mb-6 max-w-xs text-base md:text-lg">
              The ultimate platform for mastering coding interviews and landing your dream job in tech.
            </p>
          ...
          <div>
            <h3 className="font-semibold text-white mb-3 md:mb-4">Product</h3>
            <ul className="space-y-2 md:space-y-3">
              <li><a href="#" className="hover:text-orange-500 transition-colors">Home</a></li>
              <li><a href="#" className="hover:text-orange-500 transition-colors">Features</a></li>
              <li><a href="#" className="hover:text-orange-500 transition-colors">Creator</a></li>
            </ul>
          </div>
          <div>
            <h3 className="font-semibold text-white mb-3 md:mb-4">Resources</h3>
            <ul className="space-y-2 md:space-y-3">
              <li><a href="#" className="hover:text-orange-500 transition-colors">Problems</a></li>
          ...
          <div>
            <h3 className="font-semibold text-white mb-3 md:mb-4">Company</h3>
            <ul className="space-y-2 md:space-y-3">
              <li><a href="#" className="hover:text-orange-500 transition-colors">About</a></li>
              <li><a href="#" className="hover:text-orange-500 transition-colors">SignIn</a></li>
              <li><a href="#" className="hover:text-orange-500 transition-colors">SignUp</a></li>
            </ul>
          </div>
        </div>
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} MarcelPearl. All rights reserved.
          </p>
          <div className="flex items-center mt-4 md:mt-0 space-x-4 sm:space-x-6">
            <div className="flex items-center space-x-2 text-gray-400 text-sm">
              <Mail size={16} />
              <span>pearlautherizer@gmail.com</span>
            </div>
            <div className="flex items-center space-x-2 text-gray-400 text-sm">
              <Heart size={16} />
